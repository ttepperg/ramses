...
subroutine hilbert3d(x,y,z,order_min,bit_length,npoint) !TTG
  implicit none

  integer     ,INTENT(IN)                     ::bit_length,npoint
  integer     ,INTENT(IN) ,dimension(1:npoint)::x,y,z
  !real(kind=8),INTENT(OUT),dimension(1:npoint)::order
  real(kind=8),dimension(1:npoint)            ::order !TTG
  real(kind=8),INTENT(OUT)                    ::order_min !TTG
