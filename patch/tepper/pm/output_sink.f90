subroutine output_sink_csv(filename)
  ...
  !======================
  write(123,'(" # id,mass,x,y,z,vx,vy,vz,lx,ly,lz,tform,acc_rate,del_mass,rho_gas,cs**2,etherm,vx_gas,vy_gas,vz_gas,mbh,level ")')
  ...
  do isink=1,nsink
     write(123,'(I10,20(A1,ES21.10),A1,I10)')idsink(isink),',',msink(isink),&
